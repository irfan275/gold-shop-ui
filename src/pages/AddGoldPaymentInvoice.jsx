...
import {createInvoice, updateInvoice,getInvoiceById, getInvoiceNumber } from "../services/goldPaymetService";


function AddGoldPaymentInvoice() {
  const { id } = useParams();
...
export default AddGoldPaymentInvoice; 