...
import { deleteInvoice, getInvoices } from "../services/receiptService";
...
const handlePrint = (invoice) => {
  navigate("/receipt-invoice/preview", { state : { invoice: invoice, show: false }});
};
...
const formatDate = (date) => {
  ...
  <div className="d-flex justify-content-between align-items-center mb-2">
    <h3 className="m-0">Receipt Invoices</h3>

    <button
      className="btn btn-primary"
      onClick={() => navigate("/add-receipt-invoice")}
    >
      Add Invoice
    </button>
  </div>
          ...
          {invoices.map((inv) => (
            <tr key={inv._id}>
              ...
              <td>
                ...
                <button className="btn btn-sm btn-warning mx-1" onClick={() => navigate(`/receipt-invoice/edit/${inv._id}`)}>
                  Edit
                </button>
                <button
