...
function ReceiptInvoiceTemplate({ invoice ,copyType}) {
...
>
  <thead style={{ backgroundColor: "#e5e5e5" }}>
    <tr>
      ...
      <th className="p- border border-black" style={{width:'50%'}}>Particular<br />خاص</th>
      <th className="p-1 border border-black" style={{width:'25%'}}>Payment Type<br />نوع الدفع</th>
      <th className="p-1 border border-black"style={{width:'20%'}}>Amount (OMR)<br />المبلغ (بالريال العماني)</th>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    {items.map((item, i) => (
      <tr key={i}>
        ...
        <td className="p-1 border border-black">{item.particular}</td>
        <td className="p-1 border border-black">{item.type}</td>
    ...
    <tr style={{ backgroundColor: "#e5e5e5" }}>
      <td colSpan="3" className="p-1 border border-black fw-bold" >
...
export default ReceiptInvoiceTemplate;